---
{"dg-publish":true,"permalink":"/info/characters/999-npc-s/vampire-survivor/"}
---
...
### [[2 -  Sessions/Session 014\|Session 014]] - Encounter and Information
When confronted by the party, the vampire revealed extensive information about the conspiracy:
...
- Claims their magic comes from [[Molag_Bal\|Molag_Bal]], though they don't actually serve him
- Works to spread the narrative of Molag Bal involvement as misdirection
- Goal is to make populations compliant for life under a blocked sun and enslavement

#### Current Operations
- Has been using [[Info/Characters/999 NPC's/Nilan\|Nilan]] as a vampire thrall to gather blood
- Killed [[Info/Characters/999 NPC's/Nilan\|Nilan]] when he was no longer useful
- Works in alliance with the poisoned [[Dunmer\|Dunmer]] from earlier sessions as field agents
- Conducting necromantic experiments in the ruined lodge

#### Current Status
- Injured by a territorial creature in the northern forests
- Hiding in the [[Info/Locations/Ruined_Hunting_Lodge\|Ruined_Hunting_Lodge]]
...
- **[[The_Party\|The_Party]]**: Surprisingly open to conversation rather than immediate combat

## Methods and Abilities
- Necromantic magic and experimentation
- Ability to create and control vampire thralls
- Knowledge of sun-blocking magical techniques
- Field testing of supernatural terror tactics
- Alchemy and potion-making (evidenced by equipment in [[Info/Characters/999 NPC's/Nilan\|Nilan]]'s basement)

## Goals and Motivations
- Spread fear and terror to make populations compliant
- Test magical techniques for blocking sunlight
- Prepare ground for larger vampire/undead takeover
- Work toward a world where humans live under permanent darkness and servitude
...
- Represents ongoing threat even while temporarily weakened
- Knowledge of sun-blocking magic suggests significant magical resources behind conspiracy
- Alliance network indicates coordinated multi-racial supernatural threat