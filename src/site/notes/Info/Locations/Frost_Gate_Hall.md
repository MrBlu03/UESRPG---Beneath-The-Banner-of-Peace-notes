---
{"dg-publish":true,"permalink":"/info/locations/frost-gate-hall/"}
---
...
### Interior
- **Construction**: Polished oak beams throughout
- **Ceilings**: High, open ceilings creating a spacious atmosphere
- **Décor**: Silk drapes and fur rugs indicating luxury
- **Windows**: Glass windows in guest rooms (a rare and expensive feature in Skyrim)
- **Atmosphere**: Warm, welcoming, and meticulously maintained
- **Quality Level**: Significantly more upscale than typical Nord inns

### Exterior
- **Location**: Near the western gate, convenient for travelers arriving from the west
- **Stables**: Full stabling facilities for horses and pack animals
- **Accessibility**: Easy access to main thoroughfare

## Services and Amenities
- **Lodging**: Single and double rooms available
- **Stabling**: Secure facilities for horses
- **Meals**: Food service (assumed, standard for inns)
- **Drinks**: Beverage service (assumed, standard for inns)
- **Security**: Well-maintained establishment in secure town

## Room Features
- Glass windows (luxury feature rarely seen in Skyrim inns)
- Private accommodations
- Well-furnished with quality materials
- Views of the town

## Pricing
Pricing not specified but likely premium given the quality of furnishings and amenities.

## Key Events

### [[2 -  Sessions/Session 019\|Session 019]] - Party Arrival (21st of Sun's Dusk, 2E 600)
- **[[Fangs of Fjelhorst\|Fangs of Fjelhorst]]** arrived after 5-day journey from [[Info/Locations/Falderstad\|Falderstad]]
- Stabled their horses at the facility
- Secured lodging from [[Info/Characters/999 NPC's/Orgnar\|Orgnar]]:
  - **[[Info/Characters/001 The Fangs of Fjelhorst/Onasha\|Onasha]]** and **[[Info/Characters/001 The Fangs of Fjelhorst/Kirya\|Kirya]]**: Double room with glass window
  - **[[Info/Characters/001 The Fangs of Fjelhorst/Periwyn\|Periwyn]]**: Single room
  - **[[Info/Characters/001 The Fangs of Fjelhorst/Durov\|Durov]]**: Single room
