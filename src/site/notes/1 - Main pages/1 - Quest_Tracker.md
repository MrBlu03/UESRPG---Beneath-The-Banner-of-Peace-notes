...
**Key Tasks**:
- [x] Use smuggler's tunnel to enter town
- [x] Help rebuild trebuchets for diversion
- [ ] Identify the tortured victim in the keep
- [ ] Investigate the crimson orb's purpose
- [ ] Search the keep thoroughly for survivors

**Key NPCs**: 
- [[Info/Characters/Vigrod_Wraithbane\|Vigrod Wraithbane]]
- [[Info/Characters/Gjellir_Stormcrown\|Gjellir Stormcrown]]
- [[Info/Characters/Hillevi\|Hillevi]]
...
**Key Tasks**:
- [ ] Determine if the tortured man in the keep is [[Info/Characters/Wuunferth\|Wuunferth]]
...
- 🦅 Study the bone hawk remains with necromancy
